...
export const mockWakeWords = ['你好小智', '小智小智', '嗨小厨', '嗨教练', '嗨会议', '品茶', '思思']

export const mockDeviceModels = [
  'ESP32-S3-BOX', 'ESP32-S3-BOX-Lite', 'ESP32-S3-BOX-Mini', 'ESP32-S3-BOX-Pro', 'ESP32-C3'
]
